...
|----------|------------------|----------------|---------------------|
| **Go** | `github.com/marius-patrik/agents-manager/packages/core/contracts-go` | `agent_osv1 "github.com/marius-patrik/agents-manager/packages/core/contracts-go/gen/agent_os/v1"` | Go services under `../inference/` |
